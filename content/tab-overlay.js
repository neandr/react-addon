...
--------*/
  ...
  openTab: function(aTab, aArgs) {
    ...
    toolbox.setAttribute("id", "vContacts_box" + this.lastBrowserId);
    toolbox.firstChild.setAttribute("id", "vContacts_bar" + this.lastBrowserId);
    ...
    aTab.toolbar = aTab.panel.getElementsByClassName("vContacts_bar")[0];
    ...
    aTab.browser.setAttribute(
      "type",
      background ? "content-targetable" : "content-primary"
    );
    ...
    if ("onLoad" in aArgs) {
      aTab.browser.addEventListener(
        "load",
        function _vContacts_onLoad(event) {
